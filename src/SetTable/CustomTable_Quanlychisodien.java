...
public class CustomTable_Quanlychisodien extends AbstractTableModel
{
    ...
    private String name[]={"Mã HD", "Mã KH", "Tên khách hàng", "Địa chỉ","Mã tháng","Chỉ số cũ","Chỉ số mới"};
    //Khai báo lớp Chứa kiểu dữ liệu của từng trường tương ứng.
    private Class classes[]={String.class, String.class, String.class, String.class, String.class,Integer.class,Integer.class};
    ...
    public Object getValueAt(int rowIndex,int columnIndex)
    {
        ...
        {
            //Cột số a
            case 0: return ds.get(rowIndex).getMaHD();
            case 1: return ds.get(rowIndex).getNguoiDung().getMaNguoiDung();
            case 2: return ds.get(rowIndex).getNguoiDung().getHoTen();
            case 3: return ds.get(rowIndex).getNguoiDung().getDiaChi();
            //Cột b
            case 4: return ds.get(rowIndex).getThang().getMaThang();
            //cột c
            case 5: return ds.get(rowIndex).getSoDienDau();
            //cột kq
            case 6: return ds.get(rowIndex).getSoDienCuoi();
