...
public class CustomTable_Quanlykhachhang extends AbstractTableModel
{
    ...
    private String name[]={"Mã KH","Họ tên","Số CMND", "Ngày Sinh", "Địa chỉ", "Số ĐT", "Ngày Đky", "Trạng thái thanh toán", "Loại điện", "Loại tài khoản", "Tên đăng nhập", "Mật khẩu"};
    ...
    public Object getValueAt(int rowIndex,int columnIndex)
    {
        switch(columnIndex)
        {
            ...
            case 9: return ds.get(rowIndex).getTaiKhoan().getLoaiTK();
            case 10: return ds.get(rowIndex).getTaiKhoan().getUserName();
            case 11: return ds.get(rowIndex).getTaiKhoan().getPassWord();
            default :return null;
        }
    }
    @Override
